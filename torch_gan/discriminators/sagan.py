...
class SAGANDiscriminator(nn.Module):
    def __init__(self, image_size, channels=3):
        ...
        fin_size = image_size // 16

        self.l1 = DiscrBlock(channels, 128)
        self.l2 = DiscrBlock(128, 128)
        self.l3 = DiscrBlock(128, 128)
        self.attn1 = SelfAttn(128, 'relu')
        self.l4 = DiscrBlock(128, 128)
        self.attn2 = SelfAttn(128, 'relu')

        self.fin = nn.Conv2d(128, 1, fin_size)
